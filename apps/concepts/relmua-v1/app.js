...
function home(){
    ...
    const people = section("home-creators",[el("div",{class:"section-head"},[el("div",{},[label("People"),heading(2,"顔の見える、\nブランドへ。","display")]),link("すべての活動者 →","creators/",{class:"text-link"})]),el("div",{class:"people-strip"},[
        ...
        el("article",{class:"person-card person-card--draft"},[el("div",{class:"person-card__avatar",text:"朝"}),el("div",{},[heading(3,"Creator","display"),el("p",{text:"新しい視点と表現を準備中。RELMUAの次の輪郭を、少しずつ育てている。"}),el("span",{class:"text-link",text:"Coming soon"})])])
    ])]);
...
function creatorsPage(){return el("main",{},shell([pageHero("Creators","ブランドの前に、\nひとりの人がいる。","RELMUAは、誰かの名前を均質化しません。それぞれの視点と活動が、並んで見えることを大切にします。"),el("section",{class:"creator-grid"},[
    ...
    el("article",{class:"creator-profile"},[el("div",{class:"creator-profile__monogram",text:"朝"}),label("Creator / Coming soon"),heading(2,"Creator","display"),el("p",{text:"新しい活動領域を準備中。Creatorが何をつくり、何を残すのかは、これから少しずつ見えてきます。"}),el("span",{class:"text-link",text:"準備中"})])
]) ]));}
