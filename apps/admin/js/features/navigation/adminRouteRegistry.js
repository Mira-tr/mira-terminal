...
const ADMIN_ROUTES = Object.freeze({
    ...
    creators: createRoute("admin-creators", "クリエイター", "./creators/", "../admin/creators/"),
    system: createRoute("admin-system", "公開・管理", "./system/", "../admin/system/"),
    ...
    database: createRoute("system-database", "接続・データ", "./system/database/", "../admin/system/database/"),
    validation: createRoute("system-validation", "公開前チェック", "./system/validation/", "../admin/system/validation/"),
    publicExport: createRoute("system-export", "公開データを作る", "./system/export/", "../admin/system/export/"),
    backup: createRoute("system-backup", "バックアップ", "./system/backup/", "../admin/system/backup/"),
    import: createRoute("system-import", "バックアップから復元", "./system/import/", "../admin/system/import/"),
    publish: createRoute("system-publish", "公開チェック", "./system/publish/", "../admin/system/publish/"),
    activity: createRoute("system-activity", "操作履歴", "./system/logs/", "../admin/system/logs/"),
    desktop: createRoute("legacy-desktop", "旧デスクトップ", "../studio/", "./")
});
...
export function getAdminWorkspaceRoutes(){
    return {
        ...
        system: ["publicExport", "validation", "publish", "backup", "database", "import", "activity"].map(id => ADMIN_ROUTES[id])
    };
}
